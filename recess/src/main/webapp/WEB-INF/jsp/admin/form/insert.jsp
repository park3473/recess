                            ...
                            <div class="member_register_wrap">
                                <div class="member_input_wrap">
                                    <ul class="member_input">
                                        <li>
                                            <span class="list_t">기본 1</span>
                                            <input class="input_size mr" type="text" id="" value="" readonly="readonly">
                                        </li>
                                        <li>
                                        	<span class="list_t">기본 2</span>
                                        	<input class="input_title" type="text" name="" id="" >
                                        </li>
